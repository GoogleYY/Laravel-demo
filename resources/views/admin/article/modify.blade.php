...
<div class="col-md-12">
    ...
    <div class="content">
        <form action="" method="POST" class="row">
            ...
            <div class="form-group col-md-6">
                <label>作者</label>
                <input type="text" name="article_author" value="{{ $article->article_author }}" class="form-control">
            </div>
            ...
            <div class="form-group col-md-10">
                <label>封面url</label>
                <input type="text" id="image_url" name="article_cover_url"
                	   value="{{ $article->article_cover_url }}" class="form-control">
            </div>
            <div class="form-group col-md-12">
                <img id="image_view" src="{{ asset($article->article_cover_url) }}" style="max-height: 300px">
            </div>
